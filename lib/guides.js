...
export const guides = [
  {
    ...
    scope:
      'Os serviços gerais valem para estudantes da UFJF. As referências físicas vieram do campus de Juiz de Fora, e as orientações sobre o LACEE estão sinalizadas como específicas da Faculdade de Engenharia.',
  ...
  },
  {
    ...
    audience: 'Calouros de cursos de Exatas e Engenharias da UFJF.',
    scope:
      'Apresenta conceitos gerais. Datas, critérios e procedimentos devem ser confirmados no calendário vigente, no RAG e na coordenação do curso.',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            title: 'CGCO / TI',
            text: 'Área associada a sistemas, rede, conta institucional e outros serviços digitais.',
            list: [],
            links: [
              {
                label: 'Abrir a Central de Serviços de Tecnologia',
  ...
  },
  {
    ...
    audience: 'Calouros de Exatas e Engenharias; o acervo inicial tem origem na grade de Engenharia Elétrica.',
    scope:
      'As sete disciplinas herdadas não representam o primeiro período de todos os cursos. Confira sua própria grade e use somente os conteúdos que correspondem à sua turma.',
    keywords: [
      'materiais',
      'Moodle',
      'Algoritmos',
    ...
    sections: [
      ...
      {
        id: 'acervo-inicial',
        title: 'Acervo inicial de disciplinas',
        summary:
          'Estas páginas nasceram para uma turma de Engenharia Elétrica. Elas agora aparecem como uma coleção de apoio, não como uma grade universal.',
        paragraphs: [
        ...
        items: [
          ...
          {
            title: 'Cálculo I',
            text: 'Números reais, funções, limites, continuidade, derivadas e aplicações aparecem como os blocos centrais do material legado.',
            list: [
            ...
            links: [{ label: 'Página da disciplina no Departamento de Matemática', href: officialLinks.calculus, kind: 'official' }],
          ...
          },
          {
            ...
            links: [
              {
                label: 'Página da disciplina no Departamento de Matemática',
          ...
          },
          {
            ...
            text: 'Uma disciplina de ambientação para reconhecer áreas, vocabulário e possibilidades profissionais da Engenharia Elétrica.',
            list: [
          ...
          {
            title: 'Laboratório de Ciências Físicas',
      ...
      {
        id: 'bibliografia',
        title: 'Referências que já apareciam no acervo',
        ...
        items: [
          {
            ...
            text: 'Referências registradas na página legada da disciplina.',
            list: [
          ...
          {
            title: 'Cálculo I',
            text: 'Títulos registrados no plano de ensino consultado pelo projeto legado.',
            list: [
            ...
            links: [{ label: 'Conferir a página vigente de Cálculo I', href: officialLinks.calculus, kind: 'official' }],
          },
          {
            ...
            links: [
              {
                label: 'Conferir a página vigente da disciplina',
                href: officialLinks.analyticGeometry,
                kind: 'official',
              },
            ],
  ...
  },
  {
    ...
    scope:
      'A disponibilidade, os processos seletivos e os canais de cada iniciativa podem mudar. Confirme as informações diretamente com a organização.',
    ...
    sections: [
      ...
      },
      {
        ...
        summary:
          'O acervo legado reuniu estas iniciativas públicas. Use os links para conhecer o trabalho e verificar oportunidades atuais.',
        paragraphs: [
        ...
        items: [
          ...
          {
            title: 'Rinobot',
            text: 'Equipe associada a robótica, programação, eletrônica e competições autônomas.',
            list: ['Robótica', 'Programação', 'Eletrônica', 'Competição'],
            links: [{ label: 'Conhecer a Rinobot', href: 'https://www.instagram.com/rinobotbrasil/', kind: 'social' }],
          },
        ].map((item) => ({
          ...item,
          sourceLabel: item.sourceLabel ?? 'Canal público indicado no acervo legado do HELPIEEE',
  ...
  },
  {
    ...
    title: 'Conheça o Ramo IEEE UFJF e aprenda fazendo',
    summary:
    ...
    scope:
      'A composição dos grupos e os processos de entrada podem mudar. Consulte o site e o Instagram do Ramo para informações atuais.',
    keywords: ['IEEE', 'EdSoc', 'RAS', 'PES', 'WIE', 'SIGHT', 'eventos', 'projetos', 'extensão'],
    reviewedAt: CONTENT_REVIEW_DATE,
    sourceLabel: 'Ramo Estudantil IEEE UFJF e acervo editorial do HELPIEEE',
    ...
    sections: [
        ...
        items: [
          {
            ...
            links: [{ label: 'Conhecer o Ramo IEEE UFJF', href: officialLinks.ieeeUfjf, kind: 'official' }],
          },
          {
      ...
      },
      {
        ...
        paragraphs: [
          'O acervo legado descreve atividades ligadas a ciências, energias renováveis, programação, robótica e aproximação com a Engenharia.',
        ],
        items: [
          {
      ...
      {
        id: 'grupos-ieee',
        title: 'Frentes do ecossistema IEEE na UFJF',
        summary: 'Cada sigla aproxima um conjunto de temas. Conheça antes de escolher onde se envolver.',
        paragraphs: [
          'A lista reflete a organização apresentada no acervo legado. Confirme no canal do Ramo quais grupos estão ativos e como participar.',
        ],
        items: [
          {
            title: 'RAS',
          ...
          links: [
            {
              label: `Conhecer ${item.title} no Ramo IEEE UFJF`,
              href: officialLinks.ieeeUfjf,
              kind: 'official',
            },
          ],
        })),
  ...
  },
  {
    ...
    scope:
      'O guia acolhe, explica e organiza caminhos. Ele não substitui normas, sistemas, coordenações nem outros canais oficiais da UFJF.',
    keywords: ['HELPIEEE', 'EdSoc', 'IEEE UFJF', 'guia do calouro', 'fontes oficiais', 'projeto'],
    reviewedAt: CONTENT_REVIEW_DATE,
    sourceLabel: 'HELPIEEE — Education Society do Ramo IEEE UFJF',
    ...
    sections: [
      {
        ...
        paragraphs: [
          'O projeto nasceu como uma iniciativa da Education Society do Ramo IEEE UFJF para reduzir a sensação de chegar à universidade sem saber por onde começar.',
          'Seu escopo editorial agora inclui calouros de Exatas e Engenharias, respeitando as diferenças entre cursos, currículos e unidades.',
        ],
        items: [
          {
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            text: 'Monte sua base de estudo e conheça pessoas, projetos e o Ramo IEEE UFJF.',
      ...
      {
        id: 'metodologia',
        title: 'Compromissos editoriais',
        summary: 'Consistência também é uma forma de acolhimento.',
        paragraphs: [
          'O HELPIEEE deve dizer claramente quando uma orientação é geral, quando vale apenas para uma unidade e quando precisa de confirmação.',
        ],
        items: [
          {
            title: 'Clareza e inclusão',
            text: 'Texto direto, linguagem acolhedora e exemplos que não tratam uma única grade como se representasse todos os cursos.',
            list: ['Público explícito.', 'Escopo visível.', 'Siglas explicadas.'],
            links: [],
          },
          {
            title: 'Fonte e data de revisão',
            text: 'Conteúdo institucional ou sujeito a mudança deve indicar origem e revisão editorial.',
            list: ['Priorizar páginas oficiais.', 'Retirar datas vencidas.', 'Sinalizar conteúdo que exige confirmação.'],
            links: [],
          },
          {
            title: 'O guia não substitui a UFJF',
            text: 'Decisões acadêmicas, administrativas e institucionais sempre devem ser confirmadas com os canais responsáveis.',
            list: ['Normas no canal oficial.', 'Casos individuais na coordenação.', 'Problemas técnicos no suporte.'],
            links: [{ label: 'Conhecer o Ramo IEEE UFJF', href: officialLinks.ieeeUfjf, kind: 'official' }],
          },
        ],
      },
...
export const editorialNotes = Object.freeze({
  ...
  scopeDecision:
    'O HELPIEEE atende calouros de Exatas e Engenharias. Conteúdos herdados da Engenharia Elétrica foram mantidos apenas quando úteis e devidamente contextualizados.',
